...
async function video_function() {
	...
	// searching for movie 
	const search_url = `https://kd1-puce.vercel.app/movies/dramacool/${movie_name}?page=1`;
	...
	try {
		...
		for (let i = 0; i < results.length; i++) {
			...
			const info_url = `https://kd1-puce.vercel.app/movies/dramacool/info?id=${id}`; // getting movie info
